...
.PHONY: build
build:
	GOOS=darwin GOARCH=amd64 go build -o ./build/telshell_darwin $(PKG)
	GOOS=windows GOARCH=amd64 go build -o ./build/telshell_win-amd64.exe $(PKG)
	...
	GOOS=linux GOARCH=386 go build -o ./build/telshell_linux-i386 $(PKG)
